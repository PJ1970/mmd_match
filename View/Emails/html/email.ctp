...
<table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto; width:100%; max-width:600px; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:20px; ">
  ...
  <tr>
	<td style="padding:25px 15px; background:#fafafa">
		<h1 style="font-size:16px; color:#000000; margin:0 0 5px 0;">Hi, <?php echo ucfirst($user['first_name']);?>!</h1>
		<br/>
		...
		Please <a href="<?php echo $user['site'] . 'users/activateUser/'. base64_encode($user['email']) . '/' . $user['hash'];?>" target="_blank">click here </a> to activate your account.
		<br/><br/>
		Thank you.
		</p>
	</td>
