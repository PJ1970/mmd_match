<tr>
	<td style="padding:25px 15px; background:#fafafa">
		...
		<br/>
		<p style="color:#555555; font-size:13px; margin:0px;">You have recieved support ticket from <?php echo $Office['name'] ; ?><br /> 
		<p style="color:#555555; font-size:13px; margin:0px;">Ticket added by <?php echo $User['username'] ; ?><br /><br /> 
		<b>Reply By:</b> <?php	echo $User['first_name'].' '.$User['middle_name'].' '.$User['last_name'];?><br/>
