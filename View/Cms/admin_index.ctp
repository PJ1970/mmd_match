<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Cms Listing</h4>
            ...
            <div class="col-md-12">
              <div class="panel panel-primary">
				...
				<div class="col-md-12" style="padding-bottom: 20px;">
					<?php echo $this->Form->create('Cms',array('type' => 'get','url' => array('controller' => 'cms','action' => 'index'))); ?>
                      ...
                      <table id=" " class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th>  <?php echo $this->Paginator->sort('Cms.page_name','Page Name'); ?> </th>
                            <th>  <?php echo $this->Paginator->sort('Cms.title','Page Title'); ?> </th>
							<th>  <?php echo $this->Paginator->sort('Cms.created','Created Date'); ?> </th>
						...
						<tr>
							<td data-order="<?php echo $data['Cms']['id']; ?>"><?php echo $key+1; ?></td>
							<td><?php echo $data['Cms']['page_name']; ?></td>
							<td><?php echo $data['Cms']['title']; ?></td>
							<td><?php echo date('Y-m-d', strtotime($data['Cms']['created'])); ?></td>
							<td class="action_sec">
						
							&nbsp;&nbsp;<?php echo $this->Html->link('<i class="fa fa-pencil" aria-hidden="true"></i>',array('controller'=>'cms','action'=>'admin_edit', $data['Cms']['id']),array('escape'=>false,'title'=>'Edit Cms'));?>
