...
<?php echo $this->Form->create('Show', array('novalidate' => true, 'url'=>array('controller'=>'shows','action'=>'edit',@$id)));

echo $this->Form->input('id', array('type' => 'hidden', 'name' =>'id','value'=>@$id));
?>
