<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Manage Download admin</h4>
              ...
              <div class="panel panel-primary">
                <div class="panel-body">
				 <?php echo $this->Session->flash()."<br/>";?>
				  ...
				  <?php echo $this->Form->create('User',array('type' => 'get','url' => array('action' => 'super_subadmin_listing'))); ?>
					...
					<div align="right" class="col-md-4">
							<a href="<?php echo $this->HTML->url('/admin/users/addSuperSubAdmin'); ?>" class="btn btn-large btn-primary" >Add Download Admin</a>
                      ...
                      <table id="" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th> <?php echo $this->Paginator->sort('Office.name','Office'); ?></th>
						...
						<tr>
							...
							<td><?php echo !empty($data['User']['first_consent'])?date('m-d-Y', strtotime($data['User']['first_consent'])):''; ?></td>
							<td><?php $status_data = ($data['Office']['status']==1)?"Active":"Inactive"; echo "<span class=".$status_data.">".$status_data.""; ?></td>
							<td class="action_sec">
							...
							&nbsp;&nbsp;<?php echo $this->Html->link('<i class="fa fa-pencil" aria-hidden="true"></i>',array('controller'=>'users','action'=>'admin_edit_super', $data['User']['id']),array('escape'=>false,'title'=>'Edit'));?>
