...
<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Add Download admin</h4>
        </div>
      </div>
            ...
            <div class="col-sm-12">
              <div class="panel panel-primary">
                <div class="panel-body">
                  ...
                  <div class="row">
				    <?php echo $this->Form->create('User', array('novalidate' => true, 'id'=>'loginFrm', 'url'=>array('action'=>'admin_addSuperSubAdmin'),'enctype'=>'multipart/form-data'));?>
               ...
               <span style="color:#000099; font-style: italic;">Password must be between 8 to 16 characters long and contain at least one uppercase, one lowercase, one number, and one special character.</span>
						...
						<div class="form-group">
							...
							<?php 
								...
								echo $this->Form->input('office_id',array('default' => (!empty($this->request->data['User']['office_id'])) ? $this->request->data['User']['office_id'] : @$this->Session->read('Search.office'), 'options' => $options,'empty'=>'Select Office','div'=>false,'legend'=>false,'class' => 'form-control selectpicker show-tick','label' => false, 'data-live-search' => 'true', 'data-selected-text-format' => 'count > 3'));
							?>
                            </div>
                        </div>
