...
<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Edit Download admin</h4>
        </div>
      </div>
              ...
              <div class="panel panel-primary">
                <div class="panel-body">
                  ...
                  <div class="row">
				    ...
				    <?php echo $this->Form->create('User', array('novalidate' => true, 'id'=>'loginFrm', 'url'=>array('action'=>'admin_edit_super'),'enctype'=>'multipart/form-data'));?>
						   ...
						   <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<?php 
									...
									echo $this->Form->input('office_id',array('options' => $options,'empty'=>'Select Office','div'=>false,'legend'=>false,'class' => 'form-control selectpicker show-tick','label' => false, 'data-live-search' => 'true', 'data-selected-text-format' => 'count > 3'));
								?>
								</div>
							</div>
							<!--<div class="form-group">
