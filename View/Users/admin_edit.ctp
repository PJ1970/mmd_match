...
<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Edit Sub-admin</h4>
        </div>
      </div>
              ...
              <div class="panel panel-primary">
                <div class="panel-body">
                  ...
                  <div class="row">
				    ...
				    <?php echo $this->Form->create('User', array('novalidate' => true, 'id'=>'loginFrm', 'url'=>array('action'=>'admin_edit'),'enctype'=>'multipart/form-data'));?>
