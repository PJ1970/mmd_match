              ...
              <div class="panel panel-primary">
                <div class="panel-body">
				 <?php echo $this->Session->flash()."<br/>";?>
				  ...
				  <?php echo $this->Form->create('User',array('type' => 'get','url' => array('action' => 'subadmin_listing'))); ?>
					...
					<div align="right" class="col-md-4">
							<a href="<?php echo $this->HTML->url('/admin/users/addSubAdmin'); ?>" class="btn btn-large btn-primary" >Add Sub-Admin</a>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <table id="" class="table table-striped table-bordered">
						...
						<tr>
							...
							&nbsp;&nbsp;<?php echo $this->Html->link('<i class="fa fa-pencil" aria-hidden="true"></i>',array('controller'=>'users','action'=>'admin_edit', $data['User']['id']),array('escape'=>false,'title'=>'Edit'));?>
