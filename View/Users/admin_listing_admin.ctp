              ...
              <div class="panel panel-primary">
                <div class="panel-body">
				 <?php echo $this->Session->flash()."<br/>";?>
				  ...
				  <?php echo $this->Form->create('User',array('type' => 'get','url' => array('action' => 'listing_admin'))); ?>
					...
					<div align="right" class="col-md-4">
							<a href="<?php echo $this->HTML->url('/admin/users/add_admin'); ?>" class="btn btn-large btn-primary" >Add  Admin</a>
