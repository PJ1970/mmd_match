            ...
            <div class="col-sm-12">
              <div class="panel panel-primary">
                <div class="panel-body">
                  <div class="row">
				    <?php echo $this->Form->create('User', array('novalidate' => true, 'id'=>'loginFrm', 'url'=>array('controller'=>'staff','action'=>'admin_add'),'enctype'=>'multipart/form-data'));?>
                   ...
                   <div class="col-sm-6 col-xs-12">
						...
						<div class="m-t-20">
                          ...
                          <div class="form-group">
                            ...
                            <div>
							 ...
							 <?php echo $this->Form->input('password', array('type'=>'password','label'=>false,'class'=>'form-control','placeholder'=>"Password",'id'=>'password','div'=>false,'required'=>true)); ?>
						   </div>
                        ...
                        <div class="form-group">
							...
							<?php 
								...
								//pr($options); die;
								echo $this->Form->input('office_id',array('options' =>$options,'empty'=>'Select Office','div'=>false,'legend'=>false,'class' => 'form-control','label' => false, 'data-live-search' => 'true', 'default' => (!empty($this->request->data['User']['office_id'])) ? $this->request->data['User']['office_id'] : @$this->Session->read('Search.office'),'data-selected-text-format' => 'count > 3'));
							?>
                            </div>
                        </div>
						<?php endif; ?>
                          <div class="form-group m-b-0">
                            <div>
							  ...
							  <!--<a href="<?php echo $this->HTML->url('/admin/users/subadmin_listing'); ?>" class="btn btn-default waves-effect m-l-5" >Cancel</a>-->
