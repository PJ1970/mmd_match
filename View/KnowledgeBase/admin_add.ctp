...
<?php echo $this->Form->create('KnowledgeBase', array('novalidate' => true, 'url'=>array('controller'=>'knowledgeBase','action'=>'admin_add'), 'type' => 'file'));
?>
