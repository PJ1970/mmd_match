<div class="main_page_heading">
	<form method="GET" action="<?php echo WWW_BASE ?>/admin/knowledgeBase">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="page-title change_password_title">
			Manage Knowledge Base (For Coach)	
		</td>
	</tr>
	<tr>
		<td class="pull-left">
		...
		<td class="pull-right">
			<?php echo $this->Html->link('Add Knowledge Base',array('action'=>'admin_add'),array('class'=>"back_btn turn-left",'escape'=>false)); ?>
		</td>
	</tr>		
	<tr>
		<td align="center">
	...
	<tr>
		...
		<?php echo $this->Html->link('<i class="fa fa-eye"></i>',array('controller'=>'knowledgeBase','action'=>'admin_view', base64_encode($rec['KnowledgeBase']['id'])),array('escape'=>false));?>
		<?php echo $this->Html->link('<i class="fa fa-pencil-square-o"></i>',array('controller'=>'knowledgeBase','action'=>'admin_edit', $rec['KnowledgeBase']['id']),array('escape'=>false));?>
