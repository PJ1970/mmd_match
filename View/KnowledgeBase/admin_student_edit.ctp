...
<?php echo $this->Form->create('KnowledgeBase', array('novalidate' => true, 'url'=>array('controller'=>'knowledgeBase','action'=>'admin_student_edit'), 'type' => 'file'));
?>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td class="page-title change_password_title">
			Edit Knowledge Base (For Student)
		</td>
	</tr>
