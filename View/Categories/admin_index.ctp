            ...
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div class="panel-body">
				 ...
				 <?php echo $this->Form->create('Category', array('novalidate' => true, 'id'=>'officeForm','method' => 'post', 'url'=>array('controller'=>'Categories','action'=>'index')));?>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">  
                      <table id="" class="table table-striped table-bordered"> 
						...
						<tr>
							<td data-order="<?php echo $data['Category']['id']; ?>"><?php echo $key+1; ?></td>
							<td><?php echo $data['Category']['name']; ?></td>
							<td class="action_sec">
						
							&nbsp;&nbsp;<?php echo $this->Html->link('<i class="fa fa-pencil" aria-hidden="true"></i>',array('controller'=>'Categories','action'=>'admin_index', $data['Category']['id']),array('escape'=>false,'title'=>'Edit test'));?>
						...
						<?php }
						  if(isset($this->params['paging']['Category']['pageCount'])){ ?>
							<tr> 
