		...
		<div id="sidebar-menu">
			<ul>
				...
				<?php if(!empty($Admin) && $Admin['user_type'] == "Admin") { ?>
					...
					<li <?php if ($this->params['action'] == "admin_index" && $this->params['controller'] == "diagnosis") { ?>class="active_li" <?php } ?>> <a href="<?php echo $this->HTML->url('/admin/diagnosis/index'); ?>" class="waves-effect"><i class="mdi mdi-view-list"></i><span>Manage Diagnosis</span></a></li>
				...
				<li <?php if ((($this->params['action'] == "admin_version") || ($this->params['action'] == "admin_version") )&& $this->params['controller'] == "notifications") { ?>class="active_li" <?php } ?>> <a href="<?php echo $this->HTML->url('/admin/notifications/version'); ?>" class="waves-effect"><i class="mdi mdi-message-alert"></i><span>Web Version</span></a></li>
				<li <?php if ((($this->params['action'] == "admin_listing") || ($this->params['action'] == "admin_listing") )&& $this->params['controller'] == "languages") { ?>class="active_li" <?php } ?>> <a href="<?php echo $this->HTML->url('/admin/languages/listing'); ?>" class="waves-effect"><i class="mdi mdi-message-alert"></i><span>Manage Language</span></a></li>

				<li <?php if ((($this->params['action'] == "admin_index") )&& $this->params['controller'] == "user_login_logs") { ?>class="active_li" <?php } ?>> <a href="<?php echo $this->HTML->url('/admin/user_login_logs/'); ?>" class="waves-effect"><i class="mdi mdi-message-alert"></i><span>User Login Logs</span></a></li>
