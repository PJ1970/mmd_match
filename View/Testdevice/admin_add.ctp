<div class="content">
      <div class="">
        <div class="page-header-title">
          <h4 class="page-title">Add Test Device</h4>
        </div>
      </div>
					  ...
					  <div class="form-group">
							...
							<div class="form-group">
								...
								<div>
									...
									//pr($options); die;
									echo $this->Form->input('office_id',array('options' =>$options,'empty'=>'Select Office','div'=>false,'legend'=>false,'class' => 'form-control','label' => false, 'data-live-search' => 'true', 'data-selected-text-format' => 'count > 3','default'=>!empty($this->request->data['TestDevice']['office_id'])? $this->request->data['TestDevice']['office_id']: @$this->Session->read('Search.office')));
									?>
								</div>
							</div>
								<div class="form-group">
