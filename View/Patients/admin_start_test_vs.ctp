      ...
      <div class="row">
        ...
        <div class="col-sm-3 mts-box-1">
          ...
          <?php if (in_array(25, $checked_data)) {
            echo "<a style='width: 75px; background: #3292e0; color: white; border: 2px solid white;  margin-top: 3px;' href='javascript:void(0);' title='Start VS Test' class='btn ' >VS</a>";
          } ?>
                    ...
                    <div href="#" class="thrushold">
                      <div class="dropdown">
                         ...
                         <select class="mmd-dash-btn" id="test-device" onChange="checkStatus();" style="height: 30px;">
                          ...
                          <?php foreach ($test_device as $key => $value) { //pr($value);
                               ...
                               <div class="col-sm-3 va_dwc_glare_div coustom_checkbox" id="va_dwc_glare_os_div" style="visibility: hidden;">
                                ...
                                <div class="col-sm-3 va_dwc_glare_div coustom_checkbox" id="va_dwc_glare_od_div" style="visibility: hidden;">
                                 ...
                                 <div class="col-sm-6">
                                  ...
                                  <span class="checkmark"  style="border-radius: 50%;"></span>
                                       <span type="checkbox"  style="font-weight: 500; vertical-align: top; line-height: 25px; font-size: 14px;">Near with -2.5 Diopter Correction</span>
                                    </label>
...
dataCaptured=true;
  ...
  <?php  }else{ ?>
   ...
   $('#start').on('click',function(){
      ...
      for (var key of Object.keys(Vs)) { 
          if(Vs[key] == true){ 
              start_vs_test = 1;
          }
      }
      if(start_vs_test==0){
        setting_alert_new('Please Select at least 1 test.');
        return;
      }

      if ( (restartReady) && deviceId!='' && lang!=0){
          if(device_type==2 || device_type==4 || device_type==5 || device_type==8){
...
<?php if(isset($_GET['voice_instractuin'])){
 ...
 function cs_suboption(val1,val2) {
  if(val1==true || val2 ==true){
      ...
      if(cs_test_name==''){
        cs_test_name="Green";
        document.getElementById("cs").value="Gray";
      }
  }else{
    cs_test_name='';
