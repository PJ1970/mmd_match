      ...
      <div class="row">
        ...
        <div class="col-sm-3 mts-box-1">
          ...
          <?php if (in_array(34, $checked_data)) {
            echo "<a style='width: 75px; background: #3292e0; color: white; border: 2px solid white;  margin-top: 3px;' href='javascript:void(0);' title='Start Pupilometer Test' class='btn ' >PUP</a>";
          } ?>
        </div>
            </div>
