...
<body style="background: #3292e0;">
	<div class="mmd text-center"> 
		...
		<h2>Welcome To MMD</h2>
	 	<p><?php echo $name ?></p>
		<a href="https://www.portal.micromedinc.com/files/video/uploads/<?php echo $Office_folder_name.'/'.$fileName ?>" download=""><img src="<?php echo WWW_BASE.'img/admin/video-download.png';?>">Download </a>
		...
		<video   controls id="video-player"  style=" width: 100%; margin-top: 10px; display:none; visibility:hidden;">
          <source  src="<?php echo WWW_BASE ?>files/video/uploads/<?php echo $Office_folder_name.'/'.$fileName ?>" type="video/mp4">  
        </video>
